    ...
    <div class="login-container">
        <div class="login-content">
            ...
            <form @submit="gestioSubmit" class="login-form">
                <LoginTextInput v-model="name" placeholder="Nom " :has-msgError="msgError && !name" />
                <LoginTextInput v-model="last_name" placeholder="Cognom " :has-msgError="msgError && !last_name" />
                <LoginTextInput v-model="email" placeholder="Correu electrònic" :has-msgError="msgError && !email" />
                <LoginPasswordInput v-model="password" :has-msgError="msgError && !password" />
                <LoginPasswordInput v-model="confirmPassword" :has-msgError="msgError && !confirmPassword"
